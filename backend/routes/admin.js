...
router.put('/schools/:id', protect, authorize('super_admin', 'school_owner', 'principal'), ctrl.updateSchool);
router.delete('/schools/:id', protect, authorize('super_admin'), ctrl.deleteSchool);
